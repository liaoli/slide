...
public class ContentFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ;
        mFirstText = (TextView) getView().findViewById(R.id.first);
        mLastText = (TextView) getView().findViewById(R.id.last);
        mCountText = (TextView) getView().findViewById(R.id.count);
        mTotalOffsetText = (TextView) getView().findViewById(R.id.total_offset);

        final RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.main_view);

        getView().findViewById(R.id.jump).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText position = (EditText) getView().findViewById(R.id.position);
        ...
        if (BANNER_LAYOUT) {
            adapters.add(new SubAdapter(getActivity(), new LinearLayoutHelper(), 1) {
        ...
        if (FLOAT_LAYOUT) {
            ...
            adapters.add(new SubAdapter(getActivity(), layoutHelper, 1, layoutParams));
        }
        ...
        if (LINEAR_LAYOUT) {
            ...
            adapters.add(new SubAdapter(getActivity(), layoutHelper2, 6) {
        ...
        if (STICKY_LAYOUT) {
            ...
            adapters.add(new SubAdapter(getActivity(), layoutHelper, 1, new VirtualLayoutManager.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 100)));
        }
        ...
        if (COLUMN_LAYOUT) {
            ...
            adapters.add(new SubAdapter(getActivity(), layoutHelper, 5) {
        ...
        if (ONEN_LAYOUT) {
            ...
            adapters.add(new SubAdapter(getActivity(), helper, 2));
        }
        ...
        if (ONEN_LAYOUT) {
            adapters.add(new SubAdapter(getActivity(), new OnePlusNLayoutHelper(), 0));
            OnePlusNLayoutHelper helper = new OnePlusNLayoutHelper();
            ...
            adapters.add(new SubAdapter(getActivity(), helper, 3, lp) {
                @Override
                public void onBindViewHolder(MainViewHolder holder, int position) {
                    super.onBindViewHolder(holder, position);
                    VirtualLayoutManager.LayoutParams lp = (VirtualLayoutManager.LayoutParams) holder.itemView.getLayoutParams();
        ...
        if (COLUMN_LAYOUT) {
            adapters.add(new SubAdapter(getActivity(), new ColumnLayoutHelper(), 0));
            adapters.add(new SubAdapter(getActivity(), new ColumnLayoutHelper(), 4));
        }

        if (FIX_LAYOUT) {
            FixLayoutHelper layoutHelper = new FixLayoutHelper(10, 10);
            adapters.add(new SubAdapter(getActivity(), layoutHelper, 0));
        ...
        if (GRID_LAYOUT) {
            ...
            layoutHelper.setMargin(7, 0, 7, 0);
            layoutHelper.setHGap(3);
            adapters.add(new SubAdapter(getActivity(), layoutHelper, 8));
        }


        if (GRID_LAYOUT) {
            adapters.add(new SubAdapter(getActivity(), new GridLayoutHelper(4), 0));
            ...
            helper.setGap(10);
            adapters.add(new SubAdapter(getActivity(), helper, 80) {
                @Override
                public void onBindViewHolder(MainViewHolder holder, int position) {
                    super.onBindViewHolder(holder, position);
                    VirtualLayoutManager.LayoutParams lp = (VirtualLayoutManager.LayoutParams) holder.itemView.getLayoutParams();
        ...
        if (FIX_LAYOUT) {
            adapters.add(new SubAdapter(getActivity(), new ScrollFixLayoutHelper(20, 20), 1) {
                @Override
                public void onBindViewHolder(MainViewHolder holder, int position) {
                    super.onBindViewHolder(holder, position);
                    VirtualLayoutManager.LayoutParams layoutParams = new VirtualLayoutManager.LayoutParams(200, 200);
        ...
        if (LINEAR_LAYOUT)
            adapters.add(new SubAdapter(getActivity(), new LinearLayoutHelper(), 10));
        ...
        if (STAGGER_LAYOUT) {
            ...
            adapters.add(new SubAdapter(getActivity(), helper, 27) {
                @Override
                public void onBindViewHolder(MainViewHolder holder, int position) {
                    super.onBindViewHolder(holder, position);
